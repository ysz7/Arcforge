# sdk-plugin-file-template — Arcforge Plugin

> Plugin ID: `sdk-plugin-file-template` | Accepts: **file**

## Overview

This is an **Arcforge plugin**. It tells Arcforge how to parse a file and turn it into an interactive graph of nodes and edges.
