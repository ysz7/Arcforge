...
const TEMPLATES: Array<{
  ...
  // {
  //   name: 'arch-template-ddd',
  //   displayName: 'DDD (User domain)',
  //   description: 'Domain-Driven Design essentials: Domain → Entity, Value Object, Repository (interface); Use Cases depend only on the Repository port.',
  //   build: (ctx) => {
  //     const { nodeId, edgeId } = createIdGenerators();
  //     const fp = ctx.sourceNode.filePath ?? '';
  //     const domain = nodeId('arch_domain', 'User');
  //     const entity = nodeId('arch_entity', 'User');
  //     const valueObject = nodeId('arch_value_object', 'UserId');
  //     const repoPort = nodeId('arch_interface', 'UserRepository');
  //     const createUseCase = nodeId('arch_use_case', 'CreateUserUseCase');
  //     const getUserUseCase = nodeId('arch_use_case', 'GetUserUseCase');
  //     return {
  //       newNodes: [
  //         { id: domain, type: 'arch_domain' as GraphNodeType, filePath: fp, label: 'User', metadata: {} },
  //         { id: entity, type: 'arch_entity' as GraphNodeType, filePath: fp, label: 'User', metadata: {} },
  //         { id: valueObject, type: 'arch_value_object' as GraphNodeType, filePath: fp, label: 'UserId', metadata: {} },
  //         { id: repoPort, type: 'arch_interface' as GraphNodeType, filePath: fp, label: 'UserRepository', metadata: {} },
  //         { id: createUseCase, type: 'arch_use_case' as GraphNodeType, filePath: fp, label: 'CreateUserUseCase', metadata: {} },
  //         { id: getUserUseCase, type: 'arch_use_case' as GraphNodeType, filePath: fp, label: 'GetUserUseCase', metadata: {} },
  //       ],
  //       newEdges: [
  //         { id: edgeId(ctx.sourceNode.id, domain), from: ctx.sourceNode.id, to: domain, type: 'arch_dependency' },
  //         { id: edgeId(domain, entity), from: domain, to: entity, type: 'arch_dependency' },
  //         { id: edgeId(domain, valueObject), from: domain, to: valueObject, type: 'arch_dependency' },
  //         { id: edgeId(domain, repoPort), from: domain, to: repoPort, type: 'arch_dependency' },
  //         { id: edgeId(domain, createUseCase), from: domain, to: createUseCase, type: 'arch_dependency' },
  //         { id: edgeId(domain, getUserUseCase), from: domain, to: getUserUseCase, type: 'arch_dependency' },
  //         { id: edgeId(createUseCase, repoPort), from: createUseCase, to: repoPort, type: 'arch_dependency' },
  //         { id: edgeId(getUserUseCase, repoPort), from: getUserUseCase, to: repoPort, type: 'arch_dependency' },
  //       ],
  //     };
  //   },
  // },
  ...
  // {
  //   name: 'arch-template-event-driven',
  //   displayName: 'Event-Driven',
  //   description: 'Event-driven: CreateUserUseCase dispatches UserCreated, handlers (Email, Notification).',
  //   build: (ctx) => {
  //     const { nodeId, edgeId } = createIdGenerators();
  //     const fp = ctx.sourceNode.filePath ?? '';
  //     const userCreated = nodeId('arch_event', 'UserCreated');
  //     const emailHandler = nodeId('arch_handler', 'SendWelcomeEmail');
  //     const notifyHandler = nodeId('arch_handler', 'SendNotification');
  //     const createUserUseCase = nodeId('arch_use_case', 'CreateUserUseCase');
  //     return {
  //       newNodes: [
  //         { id: userCreated, type: 'arch_event' as GraphNodeType, filePath: fp, label: 'UserCreated', metadata: {} },
  //         { id: emailHandler, type: 'arch_handler' as GraphNodeType, filePath: fp, label: 'SendWelcomeEmail', metadata: {} },
  //         { id: notifyHandler, type: 'arch_handler' as GraphNodeType, filePath: fp, label: 'SendNotification', metadata: {} },
  //         { id: createUserUseCase, type: 'arch_use_case' as GraphNodeType, filePath: fp, label: 'CreateUserUseCase', metadata: {} },
  //       ],
  //       newEdges: [
  //         { id: edgeId(ctx.sourceNode.id, createUserUseCase), from: ctx.sourceNode.id, to: createUserUseCase, type: 'arch_dependency' },
  //         { id: edgeId(createUserUseCase, userCreated), from: createUserUseCase, to: userCreated, type: 'arch_dependency' },
  //         { id: edgeId(userCreated, emailHandler), from: userCreated, to: emailHandler, type: 'arch_dependency' },
  //         { id: edgeId(userCreated, notifyHandler), from: userCreated, to: notifyHandler, type: 'arch_dependency' },
  //       ],
  //     };
  //   },
  // },
